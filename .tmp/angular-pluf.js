 ...
 */
angular.module('pluf', [])
.run(["$usr", "$act", "PException", function($usr, $act, PException) {
	$act.command({
		id : 'pluf.user.login',
		label : 'login',
 ...
 * @attr {integer} tenant
 */
.factory('PContent', ["$http", "$httpParamSerializerJQLike", "$q", "PObject", function($http, $httpParamSerializerJQLike, $q, PObject) {
 ...
 */
.factory('PException', ["PObject", function(PObject) {
 ...
 */
.factory('PMenuItem', ["$window", "$act", function($window, $act) {
 ...
 * </code></pre>
 */
.factory('PNamedContent', ["$http", "$httpParamSerializerJQLike", "$q", "PObject", function ($http, $httpParamSerializerJQLike, $q,
	PObject){
 ...
 */
.factory('PaginatorPage', ["PObject", function(PObject) {
 ...
 * کند.
 */
.factory('PPreferenceNode', ["PObject", "$q", "$timeout", function(PObject, $q, $timeout) {
 ...
 */
.factory('PPreferenceProperty', ["PPreferenceNode", function(PPreferenceNode) {
 ...
 * </div>
 */
.factory('PProcess', ["PObject", function(PObject) {
 ...
 */
.factory('PProfile', ["$http", "$httpParamSerializerJQLike", "$q", "PObject", "PException", function( $http, $httpParamSerializerJQLike, $q, PObject,
	 PException) {
	/**
 ...
 */
.factory('PUser', ["$http", "$q", "$httpParamSerializerJQLike", "PObject", "PProfile", "PException", function($http, $q, $httpParamSerializerJQLike, PObject, PProfile, PException) {
	var pUser = function() {
		PObject.apply(this, arguments);
	};
 ...
 * });
 */
.service('$act',["$q", "$timeout", "PCommand", "PHandler", function($q, $timeout, PCommand, PHandler) {
	/*
 ...
 */
.service('$cms',["$http", "$httpParamSerializerJQLike", "$q", "$timeout", "PContent", "PNamedContent", "PaginatorPage", "PException", function($http, $httpParamSerializerJQLike, $q, $timeout,
 ...
 * </ul>
 */
.service('$menu', ["$q", "$timeout", "PMenu", "PMenuItem", function($q, $timeout, PMenu, PMenuItem) {
	/**
 ...
 * })
 */
.service('$notify', ["$rootScope", "$timeout", "$q", "PMessage", function($rootScope, $timeout, $q, PMessage) {
	/*
	 * فهرست شنودگرهای
	 */
	this._listeners = [];
 ...
 */
.service('$usr', ["$http", "$httpParamSerializerJQLike", "$q", "$act", "PUser", "PaginatorPage", function($http, $httpParamSerializerJQLike, $q, $act, PUser,
PaginatorPage) {
	/*
...
.run(["$window", "$act", "$tenant", "PException", function($window, $act, $tenant, PException) {
	/**
 ...
 *
 */
.factory('PSpa', ["$http", "$q", "$window", "PSpaDetail", "PObject", function($http, $q, $window, PSpaDetail, PObject) {
 ...
 */
.factory('PSpaDetail',
["$http", "$q", "$window", "PObject", function($http, $q, $window, PObject) {
 ...
 */
.factory('PTenant', ["$http", "$httpParamSerializerJQLike", "$window", "$q", "PObject", "PException", "PProfile", "PaginatorParameter", "PaginatorPage", "PSpa", function(
 ...
 *
 */
.factory('PTenantGroup', ["$http", "$q", "$window", "PObject", function($http, $q, $window, PObject) {
 ...
 */
.service('$saas', ["$http", "$httpParamSerializerJQLike", "$q", "$window", "$act", "$usr", "PTenant", "PSpa", "PException", "PaginatorParameter", "PaginatorPage", function (
 ...
 * ابزارهای مورد نیاز برای یک برچسب را ایجاد می‌کند.
 */
	.factory('PFollower',	["PObject", function(PObject) {
 ...
 */
.service('$news', ["$httpParamSerializerJQLike", "$http", "$q", "PException", "PFollower", "PaginatorPage", function($httpParamSerializerJQLike, $http, $q, PException, PFollower,PaginatorPage){
 ...
 */
	.factory('PWikiBook', ["PObject", "PException", "PWikiPageItem", "PaginatorPage", "$http", "$httpParamSerializerJQLike", "$q", "$timeout", function(PObject, PException, PWikiPageItem, PaginatorPage, $http, $httpParamSerializerJQLike, $q, $timeout) {
...
.factory('PWikiPage', ["$http", "$httpParamSerializerJQLike", "PException", "PObject", function($http, $httpParamSerializerJQLike, PException, PObject) {
 ...
 *
 */
.factory('PWikiPageItem', ["PObject", function(PObject) {
...
*/
.service('$help', ["$http", "$httpParamSerializerJQLike", "$q", "PException", "PWikiPage", "PWikiBook", "PaginatorPage", function($http, $httpParamSerializerJQLike, $q, PException, PWikiPage,
